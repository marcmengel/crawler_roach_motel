...
All pages have `<meta name="robots" content="noindex">` tags to tell 
well-behaved crawlers to ignore the pages.
...
While the title of the package is an homage to the classic Black Flag product Roach Motel(tm), it is in no way affilliated with Black Flag, nor does it have any effect on living, crawling, insects.
